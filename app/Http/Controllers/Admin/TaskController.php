...
class TaskController extends Controller
{
    ...
    private function taskI18n(): array
    {
        ...
        return [
            ...
            'contentBlocked' => __('admin.tasks.failure.content_blocked'),
            'providerFailure' => __('admin.tasks.failure.provider_failure'),
            'draftReady' => __('admin.tasks.outcome.draft_ready'),
            'draftReviewRequired' => __('admin.tasks.outcome.draft_review_required'),
