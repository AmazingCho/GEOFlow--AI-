    ...
    <div class="px-4 sm:px-0">
        ...
        <div class="grid grid-cols-1 gap-6 xl:grid-cols-[260px_minmax(0,1fr)]" data-collection-scoped-list>
            @include('admin.partials.collection-sidebar', [
                'routeName' => 'admin.title-libraries.index',
                        ...
                        <div class="px-6 py-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <a href="{{ route('admin.title-libraries.edit', ['libraryId' => (int) $library['id']]) }}" class="inline-flex items-center px-3 py-1.5 border border-green-200 text-xs font-medium rounded text-green-700 bg-green-50 hover:bg-green-100">
                                        <i data-lucide="pencil" class="w-4 h-4 mr-1"></i>
                                        {{ __('admin.button.edit') }}
                                    </a>
                                    <form method="POST" action="{{ route('admin.title-libraries.delete', ['libraryId' => (int) $library['id']] + request()->query()) }}" onsubmit="return confirm(@js(__('admin.title_libraries.confirm_delete', ['name' => $library['name']])));" class="inline-block">
                                        @csrf
