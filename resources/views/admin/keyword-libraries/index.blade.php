                        ...
                        <div class="px-6 py-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.keyword-libraries.delete', ['libraryId' => (int) $library['id']] + request()->query()) }}" onsubmit="return confirm(@js(__('admin.keyword_libraries.confirm_delete', ['name' => $library['name']])));" class="inline-block">
                                        @csrf
