@php
    ...
    $menu = [
        ...
        'crm' => ['route' => 'admin.crm.dashboard', 'name' => __('admin.nav.crm')],
    ...
    $subMap = [
        ...
        'admin.collections.index' => 'collections',
        'admin.collections.create' => 'collections',
        'admin.collections.store' => 'collections',
        'admin.collections.edit' => 'collections',
        'admin.collections.update' => 'collections',
        'admin.collections.toggle' => 'collections',
        'admin.collections.delete' => 'collections',
        'admin.crm.customers.index' => 'crm',
        'admin.crm.dashboard' => 'crm',
        'admin.crm.tasks.index' => 'crm',
        'admin.crm.tasks.store' => 'crm',
        'admin.crm.tasks.complete' => 'crm',
        'admin.crm.tasks.reopen' => 'crm',
        'admin.crm.opportunities.index' => 'crm',
        'admin.crm.opportunities.create' => 'crm',
        'admin.crm.opportunities.edit' => 'crm',
        'admin.crm.customers.create' => 'crm',
        'admin.crm.customers.store' => 'crm',
        'admin.crm.customers.show' => 'crm',
        'admin.crm.customers.edit' => 'crm',
        'admin.crm.customers.update' => 'crm',
        'admin.crm.customers.delete' => 'crm',
        'admin.crm.customers.follow-ups.store' => 'crm',
        'admin.crm.inquiries.index' => 'crm',
        'admin.crm.inquiries.create' => 'crm',
        'admin.crm.inquiries.store' => 'crm',
        'admin.crm.inquiries.analyze' => 'crm',
        'admin.crm.inquiries.show' => 'crm',
        'admin.crm.inquiries.edit' => 'crm',
        'admin.crm.inquiries.update' => 'crm',
        'admin.crm.inquiries.delete' => 'crm',
        'admin.crm.quotes.index' => 'crm',
        'admin.crm.quotes.create' => 'crm',
        'admin.crm.quotes.store' => 'crm',
        'admin.crm.quotes.show' => 'crm',
        'admin.crm.quotes.edit' => 'crm',
        'admin.crm.quotes.update' => 'crm',
        'admin.crm.quotes.print' => 'crm',
        'admin.crm.quotes.delete' => 'crm',
        'admin.crm.orders.index' => 'crm',
        'admin.crm.orders.from-quote' => 'crm',
        'admin.crm.orders.show' => 'crm',
        'admin.crm.orders.edit' => 'crm',
        'admin.crm.orders.update' => 'crm',
        'admin.crm.orders.delete' => 'crm',
        'admin.crm.tickets.index' => 'crm',
        'admin.crm.tickets.create' => 'crm',
        'admin.crm.tickets.store' => 'crm',
        'admin.crm.tickets.analyze' => 'crm',
        'admin.crm.tickets.show' => 'crm',
        'admin.crm.tickets.edit' => 'crm',
        'admin.crm.tickets.update' => 'crm',
        'admin.crm.tickets.delete' => 'crm',
        'admin.crm.proposals.index' => 'crm',
        'admin.crm.proposals.from-inquiry' => 'crm',
        'admin.crm.proposals.from-ticket' => 'crm',
        'admin.crm.proposals.apply' => 'crm',
        'admin.crm.proposals.reject' => 'crm',
        ...
        'admin.knowledge-bases.governance' => 'materials',
        ...
        'admin.knowledge-corrections.index' => 'materials',
        'admin.knowledge-corrections.store' => 'materials',
        'admin.knowledge-corrections.show' => 'materials',
        'admin.knowledge-corrections.approve' => 'materials',
        'admin.knowledge-corrections.reject' => 'materials',
        'admin.knowledge-corrections.apply' => 'materials',
        'admin.knowledge-corrections.versions.rollback' => 'materials',
        'admin.entities.index' => 'materials',
        'admin.entities.create' => 'materials',
        'admin.entities.store' => 'materials',
        'admin.entities.edit' => 'materials',
        'admin.entities.update' => 'materials',
        'admin.entities.delete' => 'materials',
        'admin.cases.index' => 'materials',
        'admin.cases.create' => 'materials',
        'admin.cases.store' => 'materials',
        'admin.cases.edit' => 'materials',
        'admin.cases.update' => 'materials',
        'admin.cases.delete' => 'materials',
        'admin.material-tags.index' => 'material_tags',
        'admin.material-tags.controlled-groups.index' => 'material_tags',
        'admin.material-tags.controlled-groups.store' => 'material_tags',
        'admin.material-tags.controlled-groups.update' => 'material_tags',
        'admin.material-tags.controlled-groups.delete' => 'material_tags',
        'admin.material-tags.store' => 'material_tags',
        'admin.material-tags.update' => 'material_tags',
        'admin.material-tags.delete' => 'material_tags',
        'admin.material-tags.bulk' => 'material_tags',
